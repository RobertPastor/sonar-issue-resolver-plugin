...
public final class UpdateAction implements IssueResolverWsAction {
	...
	public void handle(final Request request, final Response response) {
		...
		// Read issues from origin project - FROM PROJECT
		final Map<IssueKey, IssueData> issues = new HashMap<>();
		IssueHelper.forEachIssue(request.localConnector(),
				SearchHelper.findIssuesForExport(request.mandatoryParam(PARAM_FROM_PROJECT_KEY) , request.mandatoryParam(PARAM_TARGET_BRANCH)),
		...
		// add target branch as key for the search
